...
router.put('/employees/:id', upload.single('avatar'), employeeController.updateEmployee);
router.post('/employees', upload.single('avatar'), employeeController.createEmployee);
